...
$(MEM_0)_START := 0x00212000
$(MEM_0)_END := 0x00213fff
$(MEM_0)_SPAN := 0x00002000
$(MEM_0)_HIERARCHICAL_PATH := cart_memory
$(MEM_0)_WIDTH := 8
...
.PHONY: cart_memory
cart_memory: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
...
$(MEM_1)_END := 0x0020efff
$(MEM_1)_SPAN := 0x00007000
